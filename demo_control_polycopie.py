...
if __name__ == '__main__':
    ...
    def g(y):
        ...
        a=(y-5)**2
        b=2*(sigma**2)
        return G0*numpy.exp(-a/b)
    # planar wave defined on top
    f_dir[:, :] = 0.0
    f_dir[0, 0:N] = numpy.array([g(j*spacestep*10) for j in range(0,N)])
    ...
    Alpha,_ = compute_alpha.compute_alpha(w, "mousse")
    print(Alpha)
    alpha_rob = Alpha * chi
...
#     chi, energy, u, grad = solutions.optimization_procedure(domain_omega, spacestep, wavenumber, f, f_dir, f_neu, f_rob, beta_pde, alpha_pde, alpha_dir, beta_neu, beta_rob, alpha_rob,
# Alpha, mu, chi, V_obj, mu1, V_0)
    # --- en of optimization
    ...
    postprocessing._plot_abs_u_history(u0, chi0)
